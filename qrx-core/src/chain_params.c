...
int qrx_chain_write_genesis(const char *chain_dir,
    ...
    snprintf(genesis, sizeof(genesis),
        ...
        "asset_burn_policy=block_reward_units_v1\n"
        "asset_issue_main_burn_reward_units=400\n"
        "asset_issue_sub_burn_reward_units=100\n"
        "asset_issue_unique_burn_reward_units=10\n"
        "asset_issue_channel_burn_reward_units=100\n"
        "asset_issue_qualifier_burn_reward_units=1000\n"
        "asset_issue_subqualifier_burn_reward_units=100\n"
        "asset_issue_restricted_burn_reward_units=2000\n"
        "asset_reissue_burn_reward_units=40\n"
        "asset_tag_burn_reward_units=4\n"
        ...
        "fork.0.asset_burn_policy=block_reward_units_v1\n"
        "fork.0.asset_issue_main_burn_reward_units=400\n"
        "fork.0.asset_issue_sub_burn_reward_units=100\n"
        "fork.0.asset_issue_unique_burn_reward_units=10\n"
        "fork.0.asset_issue_channel_burn_reward_units=100\n"
        "fork.0.asset_issue_qualifier_burn_reward_units=1000\n"
        "fork.0.asset_issue_subqualifier_burn_reward_units=100\n"
        "fork.0.asset_issue_restricted_burn_reward_units=2000\n"
        "fork.0.asset_reissue_burn_reward_units=40\n"
        "fork.0.asset_tag_burn_reward_units=4\n"
