...
- Provider wallet credit: verified actual compute plus the provider share of any earned FastTrack surcharge.
- User/owner refund.
- FastTrack provider share: 90.0% of the earned surcharge.
- FastTrack network share: 9.5% into the QRX consensus fee/network pool.
- FastTrack development share: `FASTTRACK_DEV_SHARE_BPS = 50` (0.5% of the earned surcharge) to the configured QRX development address.
- FastTrack surcharge is capped at 25% of the maximum authorized compute budget.
...
- optional FastTrack surcharge is split 90.0% provider / 9.5% network pool / 0.5% development and is capped at 25% of the maximum compute budget,
